...
class BackupManager:
    def __init__(self, backup_dir='backups', ssl_verify=True, ssl_ca_bundle=None, retention_count=5, max_workers=10, app=None):
        """
        ...
        Args:
            ...
            max_workers: Número máximo de backups paralelos (padrão: 10)
